              ...
              >
                <motion.div variants={fadeInUp} className="space-y-4">
                  <h1 className="text-4xl lg:text-5xl font-heading font-bold text-foreground tracking-tight">
                    Unlock your true <br />
                    <span className="text-red-600">fitness potential</span>.
                  </h1>
                ...
                >
                  <div className="p-4 rounded-2xl bg-white dark:bg-card border border-border shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <h3 className="font-semibold text-foreground mb-1">Expert Trainers</h3>
                    <p className="text-sm text-muted-foreground">
                      Book sessions with certified professionals.
                    </p>
                  </div>
                  <div className="p-4 rounded-2xl bg-white dark:bg-card border border-border shadow-sm hover:shadow-md transition-shadow">
                    <div className="bg-red-600/10 w-12 h-12 rounded-xl flex items-center justify-center mb-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Manage your classes with a unified calendar.
                    </p>
                  </div>
                </motion.div>
              </motion.div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <label 
                      htmlFor="image"
                      className={`relative flex flex-1 items-center justify-center gap-2 h-12 rounded-xl border border-dashed cursor-pointer transition-all hover:bg-red-50/50 dark:hover:bg-red-950/20 hover:border-red-300 focus-within:ring-4 focus-within:ring-red-600/10 focus-within:border-red-600 ${
                        errors.image ? "border-destructive text-destructive hover:border-destructive" : "border-input text-muted-foreground hover:text-red-600"
                      }`}
                    >

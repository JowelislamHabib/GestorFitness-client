...
import { getUserNotifications, markNotificationAsRead, markAllNotificationsAsRead } from "@/lib/api/notifications";
  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <button className="relative flex size-10 items-center justify-center rounded-xl border bg-card p-1 outline-none focus-visible:ring-2 focus-visible:ring-ring hover:bg-muted transition-colors">
            ...
            <div className="divide-y divide-border/50">
              {notifications.map((notification) => (
                <div
                  ...
                  className={`relative flex flex-col gap-1 p-4 hover:bg-muted/50 transition-colors ${
